...
-(void)setThemeWithBackgroundColor:(CGFloat)back_Hue andWordColor:(CGFloat)word_Hue{
    if (word_Hue!=0) {
        self.playAgain.backgroundColor = [UIColor colorWithHue:word_Hue saturation:0.5 brightness:1.0 alpha:1.0];
    }else{
        self.playAgain.backgroundColor = [UIColor blackColor];
    }
    if (back_Hue!=0) {
        self.card.backgroundColor = [UIColor colorWithHue:back_Hue saturation:0.5 brightness:1.0 alpha:1.0];
    }else{
